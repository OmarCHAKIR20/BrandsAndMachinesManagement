            ...
            ligne +="<tr><th scope='row'>"+e.id+"</th>"
              +"<td >"+e.reference+"</td>"
               +"<td>"+e.dateAchat+"</td>"
                ...
                +"<td>"+e.prix+"</td>"
                 +"<td><button indice="+e.id+" data-role='delete' class='badge badge-secondary'>Delete</button>&nbsp;&nbsp;&nbsp;<button indice="+e.id+" data-role='update' class='badge badge-warning'>Update</button></td></tr>";
        });
